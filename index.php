	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>JAAS</h2>
				<p>Just Affordable Agricultural Store</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">JAAS &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Just Affordable Agricultural Store !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">JAAS Fam<span>Bengaluru</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:JAAS@gmail.com" style="color:white">JAAS@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About JAAS</b></span>
				JAAS is e-commerce trading platform for grains & grocerries...
			</p>
